...
const terms_and_condition = () => {
  return (
      <div className='w-5/6 max-w-[1080px] mx-auto my-10'>

        <>
           <h2 className='text-2xl font-bold'>Terms and Conditions</h2>
          <p>
              These terms and conditions outline the rules and regulations for the use of{" "}
              {/* */}mzart{/* */}'s Website, located at {/* */}www.mzart.in{/* */}.
          </p>
          <p>
              By accessing this website we assume you accept these terms and conditions.
              Do not continue to use {/* */}www.mzart.in{/* */} if you do not agree to
          ...
          <p>
              We employ the use of cookies. By accessing {/* */}www.mzart.in{/* */}, you
              agreed to use cookies in agreement with the {/* */}mzart{/* */}'s Privacy
              Policy.{/* */}{" "}
          </p>
          <p>
          ...
          <p>
              Unless otherwise stated, {/* */}mzart{/* */} and/or its licensors own the
              intellectual property rights for all material on {/* */}www.mzart.in{/* */}.
              All intellectual property rights are reserved. You may access this from{" "}
              {/* */}www.mzart.in{/* */} for your own personal use subjected to
              restrictions set in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
              <li>Republish material from {/* */}www.mzart.in</li>
              <li>Sell, rent or sub-license material from {/* */}www.mzart.in</li>
              <li>Reproduce, duplicate or copy material from {/* */}www.mzart.in</li>
              <li>Redistribute content from {/* */}www.mzart.in</li>
          </ul>
          <p>
              Parts of this website offer an opportunity for users to post and exchange
              opinions and information in certain areas of the website. {/* */}mzart
              ...
              {/* */}mzart{/* */}, its agents and/or affiliates. Comments reflect the
              views and opinions of the person who post their views and opinions. To the
              extent permitted by applicable laws, {/* */}mzart{/* */} shall not be liable
          ...
          <p>
              mzart{/* */} reserves the right to monitor all Comments and to remove any
          ...
          <p>
              You hereby grant {/* */}mzart{/* */} a non-exclusive license to use,
              reproduce, edit and authorize others to use, reproduce and edit any of your
              Comments in any and all forms, formats or media.
          </p>
          <h3 className='text-xl font-bold'>Hyperlinking to our Content</h3>
          <p>
          ...
          <p>
              ...
              e-mail to {/* */}mzart{/* */}. Please include your name, your organization
          ...
          <p>
              No use of {/* */}mzart{/* */}'s logo or other artwork will be allowed for
              linking absent a trademark license agreement.
          </p>
          <h3 className='text-xl font-bold'>iFrames</h3>
          <p>
              Without prior approval and written permission, you may not create frames
              around our Webpages that alter in any way the visual presentation or
              appearance of our Website.
          </p>
          <h3 className='text-xl font-bold'>Content Liability</h3>
          <p>
          ...
          <h3 className='text-xl font-bold'>Your Privacy</h3>
          <p>Please read Privacy Policy</p>
          <h3 className='text-xl font-bold'>Reservation of Rights</h3>
          <p>
          ...
          <h3 className='text-xl font-bold'>Removal of links from our website</h3>
          <p>
