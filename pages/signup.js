        ...
        <>
            ...
            <div className="h-screen text-center pt-20">
                ...
                <div className=" w-full ">
                    ...
                    <div>
                        <p className="text-sm text-gray-500">Already have an account? <Link legacyBehavior href="/login"><a><span className="text-black cursor-pointer hover:text-gray-800">Sign in</span></a></Link></p>
                    </div>
