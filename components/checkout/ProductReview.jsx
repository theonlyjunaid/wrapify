...
export const ProductReview1 = ({cart,subTotal}) => {
  return (
...
export const ProductReview2 = ({ cart, subTotal }) => {
    const [show, setShow] = useState('hidden')
    return (
        <div className=' md:hidden flex justify-center  bg-gray-100 px-8  rounded-xl '>
        
            <div className="sidbar   py-5  w-[100%]   z-20">
                    ...
                    {Object.keys(cart).map((key) => {
                        ...
                        return (
                            <div key={name} className='flex  border-b border-gray-10  py-[10px]' >
                                ...
                                <div className=' ml-2  items-center w-3/5'>
                                    <p className='font-mono flex items-center'>{name.split("(")[0]} </p>
                                    <p className='font- text-gray-500 my-[5px]'>{varient}</p>
                                    <div className='flex'>
                                        <p className='font- text-gray-500 my-[5px]'>Size: {size} /</p>
                                        <p className='font- text-gray-500 my-[5px] ml-1'>Qty: {qty}</p>
                                    </div>
