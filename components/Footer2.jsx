...
const Footer2 = () => {
    ...
    return (
            ...
            <div className="container  px-5 py-5 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap justify-between flex-wrap flex-col">
                ...
                <div className="text-center level4:text-start my-2" >
                    ...
                    <ul className="font-mono">
                        ...
                        <li className="text-black hover:text-gray-400">
                            <Link href="/refund_return_policy">Refund/Return Policy</Link>
                        </li>
                ...
                {/* <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Login</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Sign up</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Orders</Link>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Skin</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Second Link</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Third Link</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Fourth Link</Link>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">About us</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Contact Us</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Privacy policy</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Terms and condition</Link>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-gray-600 hover:text-gray-100">Contact Us</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Track Your Order</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Refund Policy</Link>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Payment Issue</Link>
                            </li>
            ...
            <div className="border-t-2 border-b-2 border-black">
                <div className="container mx-auto pt-4 px-5 flex flex-wrap w-full flex-col sm:flex-row justify-center items-center level4:items-start level4:justify-between">
                    ...
                    <div>
                        ...
                        <img src="icons/payment.png" alt="payment methods" />
        ...
        //             <ul className="font-mono">
        //                 <li>
        //                    <Link href=""><a className="text-white hover:text-gray-400">Login</Link>
        //                 </li>
        //                 <li>
        //                    <Link href=""><a className="text-white hover:text-gray-400">Sign up</Link>
        //                 </li>
        //                 <li>
        //                    <Link href=""><a className="text-white hover:text-gray-400">Track Order</Link>
        //                 </li>
        ...
        //             <ul className="font-mono">
        //                 <li>
        //                    <Link href=""><a className="text-white hover:text-gray-400">About Us</Link>
        //                 </li>
        //                 <li>
        //                    <Link href=""><a className="text-white hover:text-gray-400">Contact Us</Link>
        //                 </li>
        //                 <li>
        //                    <Link href=""><a className="text-white hover:text-gray-400">FAQs</Link>
        //                 </li>
        ...
        //             <ul className="font-mono">
        //                 <li>
        //                    <Link href=""><a className="text-white hover:text-gray-400">Privacy Policy</Link>
        //                 </li>
        //                 <li>
        //                    <Link href=""><a className="text-white hover:text-gray-400">Terms and Conditions</Link>
        //                 </li>
        //                 <li>
        //                    <Link href=""><a className="text-white hover:text-gray-400">Return Policy</Link>
        //                 </li>
